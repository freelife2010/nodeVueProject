<template>
    ...
    <!-- END Top Navbar-->
</header>                <aside class="aside" v-show="openAside">
    <!-- START Sidebar (left)-->
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div id="table_filter" class="dataTables_filter"><label>Search:<input type="text" class="form-control input-sm" placeholder="" aria-controls="table" v-model="searchNname"></label></div><div id="table_processing" class="dataTables_processing" style="display: none;">Processing...</div><table id="table" class="table table-striped table-hover  dataTable no-footer" role="grid" aria-describedby="table_info" style="width: 1057px;">
                        <thead>
                        <tr role="row">
                            <th class="sorting" v-bind:class="{ sorting_desc: sortCountry }" v-on:click="sortByCountry" tabindex="0" aria-controls="table" rowspan="1" colspan="1"  aria-label="Country: activate to sort column ascending">Country</th>
                            <th class="sorting"  v-bind:class="{ sorting_desc: sortDest }" tabindex="0" aria-controls="table" rowspan="1"  colspan="1"  aria-label="Destination: activate to sort column ascending" v-on:click="sortByDest">Destination</th>
...
var devCount = localStorage.getItem("devCount");
    ...
    created: function(){
           ...
           this.checkId = localStorage.getItem("userUuid");
            ...
            document.title = 'Termination Rates :: Developer UI';
        },
