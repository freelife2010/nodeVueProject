                ...
                <div class="panel-body">
                    <div id="table_wrapper" class="dataTables_wrapper form-inline no-footer">
                        ...
                        <div id="table_filter" class="dataTables_filter">
                            <label>Search:<input v-model="searchNname" autofocus class="form-control input-sm" aria-controls="table"></label>
                        </div>
                        ...
                        <thead>
                        <tr role="row">
                            <th class="sorting"  v-bind:class="{ sorting_desc: sortCountry }" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Country: activate to sort column ascending" style="width: 215px;" v-on:click="sortByCountry()">Country</th>
                            ...
                            <th class="" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Code: activate to sort column ascending" style="width: 88px;" v-on:click="sortByCode">Code</th>
                        ...
                        <tbody>
                            <tr role="row" class="odd" v-for="listRates in ratesArray">
                                <td>{{ listRates.country }}</td>
                                <td>{{  }}</td>
                                <td>{{ listRates.code }}</td>
                                <td class="sorting_1">
                                    <div class="form-group">
                                        <input class="form-control" step="0.01" style="width: 80px" :value="listRates.rate" id="ratesEdit" type="number" name="rateName">
                                    </div>
                    ...
                    </table><div class="dataTables_info" id="table_info" role="status" aria-live="polite">Count of Origination Rate - {{ratesCount}}</div><div class="dataTables_paginate paging_simple_numbers" id="table_paginate">
